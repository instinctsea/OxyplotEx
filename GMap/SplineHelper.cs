...
namespace OxyplotEx.GMap
{
    ...
    internal static class CanonicalSplineHelper
    {
        ...
        internal static List<DataPoint> CreateSpline(
            IList<DataPoint> points, double tension, IList<double> tensions, bool isClosed, double tolerance)
        {
        ...
        internal static List<DataPoint> ScreenPointToDataPoint(IList<ScreenPoint> sps)
        {
            List<DataPoint> dps = new List<DataPoint>();
            foreach (ScreenPoint sp in sps)
                dps.Add(new DataPoint(sp.X, sp.Y));
